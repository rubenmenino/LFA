// Generated from /home/utilizador/Desktop/LFA/Bloco2/Ex3/Calculator.g4 by ANTLR 4.7.1
				...
				if ( _alt==1 ) {
					...
					case 1:
						...
						((ExprContext)_localctx).right = expr(5);
						 if((((ExprContext)_localctx).op!=null?((ExprContext)_localctx).op.getText():null).equals("*")) ((ExprContext)_localctx).v =  ((ExprContext)_localctx).left.v * ((ExprContext)_localctx).right.v; else ((ExprContext)_localctx).v =  ((ExprContext)_localctx).left.v / ((ExprContext)_localctx).right.v; 
						}
						break;
					case 2:
						{
